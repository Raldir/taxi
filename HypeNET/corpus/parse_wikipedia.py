...
def check_direction(lch, hs, f_dir):
    """
    Make sure that the path between the term and the lowest common_ head is in a certain direction
    :param lch: the lowest common_ head
    :param hs: the path from the lowest common_ head to the term
...
def get_satellite_links((x, hx, lch, hy, y)):
    ...
    :param lch: the lowest common_ ancestor of X and Y
