...
def main():
    ...
    Usage:
        ...
        <output_directory> = the directory in which the train_/test/validation sets should be saved
    """)
    ...
    # Split to train_, test and validation such that each set contains a distinct vocabulary
    lex = [[], [], []]
    lex_mixed = []
    ...
    with codecs.open(output_directory + '/train_.tsv', 'w', 'utf-8') as f_out:
...
def hash_word(s):
    ...
    be assigned to the train_ set, then to the test set and the least words will
